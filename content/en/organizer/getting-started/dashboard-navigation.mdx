...
- **Team Management Dashboard**: Your starting point after login. Here, you handle team settings, [member invites](/docs/organizer/invite-member), and creating new events. It's like your "control center" for the whole organization.
