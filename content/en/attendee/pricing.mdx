...
- **Processing Fee**: A one-time charge for secure payment processing. Calculated as: **Base Fee + (Subtotal × Percentage Fee), with a minimum charge per order**.
  - **Credit/Debit Card**: HK\$2.35 + 3.9% of subtotal.
  - **Alipay HK**: HK\$1.00 + 2.5% of subtotal, minimum HK\$2.00.
  - **WeChat Pay**: HK\$1.00 + 2.5% of subtotal, minimum HK\$2.00.
  - **PayMe**: HK\$0 + 1.6% of subtotal, minimum HK\$2.00.
  - **FPS**: HK\$0 + 2.0% of subtotal, minimum HK\$2.00.
