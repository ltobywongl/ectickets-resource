...
- **Processing Fee**: A one-time charge for secure payment processing. Calculated as: **Base Fee + (Subtotal × Percentage Fee), with a minimum charge per order**.
  - **Credit/Debit Card**: HK\$2.35 + 3.9% of subtotal, minimum HK\$2.35.
  - **Alipay HK**: 0 + 2.0% of subtotal, minimum HK\$2.00.
  - **WeChat Pay**: 0 + 2.0% of subtotal, minimum HK\$2.00.
  - **PayMe**: 0 + 1.5% of subtotal, minimum HK\$2.00.
  - **FPS**: 0 + 1.8% of subtotal, minimum HK\$2.00.
