...
- **Processing Fee**: A one-time charge for secure payment processing. Calculated as: **Base Fee + (Subtotal × Percentage Fee), with a minimum charge per ticket**.
  - **Credit/Debit Card**: HK\$2.35 + 3.9% of subtotal, minimum HK\$2.35 per ticket.
  - **Alipay HK**: 0 + 2.0% of subtotal, minimum HK\$2.00 per ticket.
  - **WeChat Pay**: 0 + 2.0% of subtotal, minimum HK\$2.00 per ticket.
  - **PayMe**: 0 + 1.5% of subtotal, minimum HK\$2.00 per ticket.
  - **FPS**: 0 + 1.8% of subtotal, minimum HK\$2.00 per ticket.
...
> [!TIP]
>
> **Free Tickets**: There is no processing fee added if the ticket price is free of charge.
